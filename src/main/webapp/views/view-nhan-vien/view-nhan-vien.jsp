...
<section>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-4">
                <a href="/nhan-vien/view-add" class="btn btn-warning">ADD NHÂN VIÊN</a>&emsp;&emsp;
                <a href="/nhan-vien/hien-thi" class="btn btn-warning">HIỂN THỊ NHÂN VIÊN</a>&emsp;&emsp;
            </div>
            <div class="col-2">
            ...
            <div class="col-6">
                <form action="/nhan-vien/tim-kiem">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <button class="btn btn-warning" type="submit">SẮP XẾP NHÂN VIÊN</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="container">
        <table class="table">
            ...
            <tbody>
            <c:forEach items="${listNhanViens}" var="nv" varStatus="i">
                <tr>
                    <td>${i.index+1}</td>
                    <td>${nv.ma}</td>
                    ...
                    <td>
                        <a href="/nhan-vien/view-update?id=${nv.id}" class="btn btn-success">UPDATE</a>&emsp;
                        <a href="/nhan-vien/remove?id=${nv.id}" onclick="confirm('BẠN CHẮC XÓA KHÔNG !')"
