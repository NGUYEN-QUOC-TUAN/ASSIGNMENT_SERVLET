...
<section>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-4">
                <a href="/cua-hang/view-add" class="btn btn-warning">ADD CỬA HÀNG</a>&emsp;&emsp;
                <a href="/cua-hang/hien-thi" class="btn btn-warning">HIỂN THỊ CỬA HÀNG</a>&emsp;&emsp;
            </div>
            <div class="col-2">
            ...
            <div class="col-6">
                <form action="/nhan-vien/tim-kiem">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <button class="btn btn-warning" type="submit">SẮP XẾP CỬA HÀNG</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <table class="table">
            ...
            <c:forEach items="${listCuaHangs}" var="cuaHang" varStatus="i">
                <tr>
                    ...
                    <td>
                        <a href="/cua-hang/view-update?id=${cuaHang.id}" class="btn btn-success">UPDATE</a>&emsp;
                        <a href="/cua-hang/remove?id=${cuaHang.id}" onclick="confirm('BẠN CHẮC XÓA KHÔNG !')"
