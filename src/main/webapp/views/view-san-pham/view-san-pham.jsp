...
<section>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-4">
                <a href="/san-pham/view-add" class="btn btn-warning">ADD</a>&emsp;&emsp;
                <a href="/san-pham/hien-thi" class="btn btn-warning">HIỂN THỊ</a>&emsp;&emsp;
            </div>
            <div class="col-2">
        ...
        <table class="table">
            ...
            <c:forEach items="${listSanphams}" var="sp" varStatus="i">
                <tr>
                    ...
                    <td>${sp.ten}</td>
                    <td>
                        <a href="/san-pham/view-update?id=${sp.id}" class="btn btn-success">UPDATE</a>&emsp;
                        <a href="/san-pham/remove?id=${sp.id}" class="btn btn-success"
