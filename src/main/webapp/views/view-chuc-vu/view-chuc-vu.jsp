...
<section>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-4">
                <a href="/chuc-vu/view-add" class="btn btn-warning">ADD</a>&emsp;&emsp;
                <a href="/chuc-vu/hien-thi" class="btn btn-warning">HIỂN THỊ</a>&emsp;
            </div>
            <div class="col-2">
            ...
            <div class="col-6">
                <form action="">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <button class="btn btn-warning" type="submit">SẮP XẾP CHỨC VỤ</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <table class="table">
            ...
            <c:forEach items="${listChucVus}" var="chucVu" varStatus="i">
                <tr>
                    ...
                    <td>${chucVu.ten}</td>
                    <td>
                        <a href="/chuc-vu/view-update?id=${chucVu.id}" class="btn btn-success">UPDATE</a>&emsp;
                        <a href="/chuc-vu/remove?id=${chucVu.id}" class="btn btn-success">REMOVE</a>&emsp;
                    </td>
                </tr>
            </c:forEach>
            </tbody>
