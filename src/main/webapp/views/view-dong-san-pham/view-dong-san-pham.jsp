...
<section>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-4">
                <a href="/dong-san-pham/view-add" class="btn btn-warning">ADD</a>&emsp;&emsp;
                <a href="/dong-san-pham/hien-thi" class="btn btn-warning">HIỂN THỊ</a>&emsp;&emsp;
            </div>
            <div class="col-2">
            ...
            <div class="col-6">
                <form action="/may-tinh/sap-xep">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <button class="btn btn-warning" type="submit">SẮP XẾP DÒNG SẢN PHẨM</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="container">
        <table class="table">
            ...
            <tbody>
            <c:forEach items="${listDongSanPhams}" var="dongSanPham" varStatus="i">
                <tr>
                    <td>${i.index+1}</td>
                    <td>${dongSanPham.ma}</td>
                    <td>${dongSanPham.ten}</td>
                    <td>
                        <a href="/dong-san-pham/view-update?id=${dongSanPham.id}" class="btn btn-success">UPDATE</a>&emsp;
                        <a href="/dong-san-pham/remove?id=${dongSanPham.id}" class="btn btn-success"
