...
<section>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-4">
                <a href="/nha-san-xuat/view-add" class="btn btn-warning">ADD</a>&emsp;&emsp;
                <a href="/nha-san-xuat/hien-thi" class="btn btn-warning">HIỂN THỊ</a>&emsp;&emsp;
            </div>
            <div class="col-2">
    ...
    <div class="container">
        <table class="table">
            ...
            <tbody>
            <c:forEach items="${listNhaSanXuats}" var="nhaSanXuat" varStatus="i">
                <tr>
                    <td>${i.index+1}</td>
                    <td>${nhaSanXuat.ma}</td>
                    <td>${nhaSanXuat.ten}</td>
                    <td>
                        <a href="/nha-san-xuat/view-update?id=${nhaSanXuat.id}" class="btn btn-success">UPDATE</a>&emsp;
                        <a href="/nha-san-xuat/remove?id=${nhaSanXuat.id}" class="btn btn-success"
