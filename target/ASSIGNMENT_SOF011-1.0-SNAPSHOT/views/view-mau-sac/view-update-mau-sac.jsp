            ...
            <div class="row">
                <div class="col-6">
                    <div class="form-floating mb-3">
                        ...
                        <label>MÃ MÀU SẮC <span style="color: red;">${maTrong}</span></label>
                    </div>
                </div>
                <div class="col-6">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" value="${mauSac.ten}" name="ten">
                        <label>TÊN MÀU SẮC <span style="color: red;">${tenTrong}</span></label>
                    </div>
                </div>
            </div>
            <br>
            <hr>
            <a href="/mau-sac/hien-thi" class="btn btn-warning">TRỞ VỀ MÀU SẮC</a>&emsp;
            <button class="btn btn-warning" type="submit">UPDATE MÀU SẮC</button>&emsp;
            <br>
            <hr>
        </form>
    </div>
